...
public class AlgebraPanel extends JPanel {
    ...
    private JPanel buildInputsPanel() {
        ...
        buttonRow.add(makeButton("Degree(A)",e -> compute(Op.DEGREE)));
        panel.add(buttonRow);
    ...
    private enum Op { ADD, SUBTRACT, MULTIPLY, DEGREE }
        ...
        try {
            ...
            switch (op) {
                ...
                case SUBTRACT:
                    ...
                    break;
                case DEGREE:
                    int degree = controller.degree(fieldA.getText());
                    showResult("Degree(A) = " + degree, false);
                    return;
                default:
